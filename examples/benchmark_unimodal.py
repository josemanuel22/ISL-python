...
dataset = TensorDataset(train_data, train_data)  # Using train_data as both inputs and targets for simplicity
loader = DataLoader(dataset, batch_size=hparams['samples'], shuffle=True)
